**DraculaN Season 6 \- Official Tournament Rulebook**
...
**Event Name:** DraculaN Season 6 \- Counter-Strike 2 Open LAN
...
Each group will contain exactly one team from each pot. The group stage draw will be posted on the official discord channel \- [https://discord.gg/rZ4r3d3ahx](https://discord.gg/rZ4r3d3ahx), as well as our X \- [https://x.com/digital\_crusade](https://x.com/digital_crusade) .
...
The top 8 seeds will be the teams directly seeded into the playoffs. The order of the top 8 teams is based on the VRS rank, according to the official February VRS ranking from Valve.

Seeds 9–12 will be the teams that have won their group. The order of seeds 9–12 is based on VRS rank or the criteria that was used for initial seeding when they joined the tournament. If no VRS rank was available, the HLTV ranking and average FACEIT ELO was used instead.

Seeds 13–16 will be the teams that finished in second place in the group stage. The order of seeds 13–16 is based on VRS rank or criteria that was used for initial seeding when they joined the tournament. If no VRS rank is available, the HLTV ranking and average FACEIT ELO was used instead.

This seeding order will be used for veto purposes in the playoffs.
...
The DraculaN Season 6 tournament prize pool is fully crowdfunded by team registration fees. There is no base prize pool funded by the organizer. The total prize pool depends on the number of participating teams, with a maximum cap of 24 teams.
...
In the unlikely event that **DraculaN Season 6**  is postponed or canceled due to unforeseen circumstances (including but not limited to natural disasters, venue failure, national emergencies, or health crises), the organizers will:  
...
Update 25.02.2026, 19:39 GMT+2

Further clarifications regarding seeding rules for the playoffs:
...
Let’s make this a memorable event for everyone: players, viewers, and staff alike. Good luck and have fun to all teams, and welcome to **DraculaN Season 6**.  
